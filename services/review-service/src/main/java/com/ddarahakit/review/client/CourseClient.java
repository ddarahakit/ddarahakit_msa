...
/**
 * course-service 가 아직 없으므로 모놀리스(/course/{courseIdx})를 직접 URL 로 호출해 코스 존재를 확인한다.
 ...
 */
@FeignClient(name = "course-existence", url = "${monolith.url}")
public interface CourseClient {
    ...
    record CourseInfo(Long idx, String name, String image) {
    }
}
